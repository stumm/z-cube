 ...
 *
 * Copyright (C) 2007-2009 ZeroG Wireless Inc.  All rights
 * reserved.
 *
 * ZeroG Wireless licenses to you the right to use, modify, copy, and
 * distribute the Software driver source files when used in conjunction
 * with a ZeroG licensed IC product ("Device") which is integrated into
 * Licensee's product.
 *
